export const styles = {
  ...
  container: 'xs:max-w-[1280px] w-full',
  flexCenter: 'justify-center items-center',
  flexMaxsus: 'flex justify-end items-center',
...
export const layout = {
  ...
  sectionInfo: `flex-1 ${styles.flexCenter} md:ml-10 ml-0 relative`,
  sectionImage: `flex-1 flex ${styles.flexCenter} md:ml-10 ml-0 relative`,
  sectionImageReverse: `flex-1 flex ${styles.flexCenter} md:mr-10 mr-0 md:mt-10 mt-0 relative`
}